...
module Number
  ...
  def kronecker(a, b)
    ...
    loop {
      ...
      r = b - a
      if r > 0; if a & b & 2 == 2; k = -k; end; b = a; a = r; else a = -r; end
    }
  end
...
=end
  ...
  def prime_factors(n, upperLimit = 0) # list of prime p dividing n
    if upperLimit == 0
      ...
      while (r1 <= d)
        if n % r1 == 0; f.push(r1)
          while n % r1 == 0; n = n.div(r1); end; d = sqrti(n);         end
        if n % r2 == 0; f.push(r2)
          while n % r2 == 0; n = n.div(r2); end; d = sqrti(n);         end
        r1 = r1 + 6; r2 = r2 + 6
      end
      if n != 1; f.push(n); end
      return f
  ...
  def getDivisors(n)
    ...
    while i < factors.size
      if factors[i] == factors[i + 1]; factord[i] += 1; factors.delete_at(i + 1); else i = i + 1; factord[i] = 1 end
    end
